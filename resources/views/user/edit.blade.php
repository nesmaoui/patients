                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group-append">
                                         ...
                                         <input id="cin" type="text" class="form-control{{ $errors->has('cin') ? ' is-invalid' : '' }}" name="cin" value="{{ $user->cin }}" required autofocus>
                                </div>
                                @if ($errors->has('cin'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group-append">
                                         ...
                                         <textarea id="adr" type="text" class="form-control{{ $errors->has('adr') ? ' is-invalid' : '' }}" name="adr" value="{{ $user->adr }}" required autofocus></textarea>
                                </div>
                                @if ($errors->has('adr'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group-append">
                                         ...
                                         <input id="num" type="text" class="form-control{{ $errors->has('num') ? ' is-invalid' : '' }}" name="num" value="{{ $user->num }}" required autofocus>
                                </div>
                                @if ($errors->has('num'))
                                    <span class="invalid-feedback" role="alert">
